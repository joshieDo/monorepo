    ...
    D: Provider<PublicKey = P>,
{
    ...
    #[tracing::instrument(name = "broadcast.handle_broadcast", target = "lifecycle", level = "debug", skip_all, fields(block_hash = %msg.digest()))]
    ...
    #[tracing::instrument(name = "broadcast.handle_subscribe", target = "lifecycle", level = "debug", skip_all, fields(block_hash = %digest))]
    ...
    #[tracing::instrument(name = "broadcast.handle_get", target = "lifecycle", level = "debug", skip_all, fields(block_hash = %digest))]
    ...
    #[tracing::instrument(name = "broadcast.handle_network", target = "lifecycle", level = "debug", skip_all, fields(block_hash = %msg.digest()))]
    ...
    #[tracing::instrument(name = "broadcast.insert_cache_entry", target = "lifecycle", level = "debug", skip_all, fields(block_hash = %digest))]
    ...
    #[tracing::instrument(name = "broadcast.respond_subscribe", target = "lifecycle", level = "debug", skip_all, fields(block_hash = %msg.digest()))]
    ...
    #[tracing::instrument(name = "broadcast.respond_waiters", target = "lifecycle", level = "debug", skip_all, fields(block_hash = %msg.digest()))]
